...
SELECT   event_time, a.action_id, action_id_desc, a.class_type,class_type_desc, securable_class_desc , session_server_principal_name, server_principal_name, database_name, object_name, statement as query  FROM sys.fn_get_audit_file('F:\prueba123\nueva_auditoria_user*.sqlaudit', DEFAULT, DEFAULT) as a  
